...
do
    if [ "$line" = "-" ]; then
        ...
        scp /hdfs-test/hadoop-2.9.2.tar.gz root@$line:/hdfs-test/ && scp /hdfs-test/setup.py root@$line:/hdfs-test/ && scp /hdfs-test/manager root@$line:/hdfs-test/ && scp /hdfs-test/workers root@$line:/hdfs-test/
        echo "Setup $line"
